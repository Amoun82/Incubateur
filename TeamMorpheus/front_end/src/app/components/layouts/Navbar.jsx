                    ...
                    <div className="flex-1 flex items-center justify-center sm:items-stretch mt-4">
                        <div className="sm:block sm:ml-6 md:w-full lg:w-full">
                            <div className="flex md:justify-evenly place-content-around mb-4">
                                ...
                                <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:pr-0 ">
                                    ...
                                    <Menu as="div" className="lg:ml-40 lg:mr-10 relative">
                                        <div>
                                            <Menu.Button className="flex sm:text-sm focus:outline-none text-cyan-500 focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                                    ...
                                    <div className="">
                                        <button
                                            type="button"
                                            className="ml-3 h-8 w-8 lg text-cyan-500"
                                        >
                                            <FontAwesomeIcon
                                                icon={faBagShopping}
                                                size="3x"
                            ...
                            <div className="hidden sm:flex place-content-around mb-4">
                                {/*menu for admin and commercial*/}
                                {isAuthenticated() && isAdmin() && (
                                    <Link to={URL_ADD_PRODUCT}>
                                        <div className="px-4 py-2 text-sm text-gray-700 hover:text-black hover:font-bold hover:scale-125 ease-in duration-200 hover:bg-teal-300 link">
                                            Add product
                                        </div>
                                    </Link>
                                )}
