...
final class Version20220620131947 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE product_color ADD CONSTRAINT FK_C70A33B588D309D9 FOREIGN KEY (id_color) REFERENCES color (id_color) NOT DEFERRABLE INITIALLY IMMEDIATE');
